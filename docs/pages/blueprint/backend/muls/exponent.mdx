...
$$
\begin{equation*}(g^{p[x]})^{q[x]} = g^{p[x] \cdot q[x]} \stackrel{?}= g^{2^{64} \cdot \text{hi}[x] + \text{lo}[x]} = \left( g^{2^{64}} \right)^{\text{hi}[x]} \cdot g^{\text{lo}[x]}\end{equation*}
$$
...
$$
\begin{equation*}(g^{p[x]})^{q[x]} \stackrel{?}= \left( g^{2^{64}} \right)^{\text{hi}[x]} \cdot g^{\text{lo}[x]}\end{equation*}
$$
