...
Both our [AND](/blueprint/backend/ands) and [MUL](/blueprint/backend/muls) reductions closed out by outputting evaluation claims on the [oblong-multilinearizations](/blueprint/math/oblong) of these constraint arrays. In order to assess validity of these claims, we need to connect them mathematically to the witness.
