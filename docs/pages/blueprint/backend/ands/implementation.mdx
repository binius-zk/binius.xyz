# The Rijndael Zerocheck [Our efficient prover implementation of our univariate skip variant]
...
Our prover algorithm below makes use of the [constraint arrays](/blueprint/constraints/ands#the-constraint-arrays) $a$, $b$ and $c$. As we [have seen](/blueprint/constraints/arrays#efficient-algorithm), there is a straightforward way that the prover can compute these, on input his witness $w$ and the constraint system.
