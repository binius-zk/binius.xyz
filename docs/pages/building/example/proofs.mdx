...
```bash
cargo add binius-verifier --git https://github.com/binius-zk/binius64
cargo add binius-prover --git https://github.com/binius-zk/binius64
cargo add binius-transcript --git https://github.com/binius-zk/binius64
```
