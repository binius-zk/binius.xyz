...
\begin{align}
  \alpha_z \stackrel{?}{=} \sum_{o_1, o_2 \in \BB_3} \sum_{s_1, s_2 \in \BB_6} \sum_{j, k, i \in \BB_6} \sum_{y \in \BB_{\ell_\text{words}}} &\delta_D(r_{\widehat{i}}, \widehat{i}) \cdot \mle{Z}_\text{cons}(r'_x, y, s_1, o_1, s_2, o_2) \notag \\
  &{} \cdot \mle{\textsf{shift-ind}}(i, k, s_2, o_2) \cdot \mle{\textsf{shift-ind}}(k, j, s_1, o_1) \cdot \mle{w}(j, y).
...
\begin{align*}
  \gamma \stackrel{?}{=} \; &\mle{\delta}_D(r_{\widehat{i}}, r_i) \cdot \mle{Z}_\text{cons}(r'_x, r_y, r_{s_1}, r_{o_1}, r_{s_2}, r_{o_2}) \\
...
\begin{align*}
  ...
  g(J, S_1, O_1, S_2, O_2) &\coloneqq \sum_{y \in \BB_{\ell_\text{words}}} \mle{Z}_\text{cons}(r'_x, y, S_1, O_1, S_2, O_2) \cdot \mle{w}(J, y).
\end{align*}
