...
\[
  O_1, \quad S_1, \quad O_2, \quad S_2, \quad J, \quad K, \quad I, \quad Y,
\]
producing challenges $r_{o_1}, r_{o_2} \in K^3$, $r_{s_1}, r_{s_2} \in K^6$, $r_j, r_k, r_i \in K^6$, and $r_y \in K^{\ell_\text{words}}$. This order is what admits the efficient multi-phase prover algorithm of \S\ref{sec:shift-reduction-prover}. The sumcheck closes with the claim
\begin{align*}
